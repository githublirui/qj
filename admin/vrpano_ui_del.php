...
if($row[$GLOBALS['OOO0000O0']('dWlzaG93cGlj')]!=""){
checkdelfile($basedir."/showpic/".$row[$GLOBALS['OOO0000O0']('dWlzaG93cGlj')]);
}
if($row[$GLOBALS['OOO0000O0']('aW1nZmlsZQ==')]!=""){
checkdelfile($basedir."/ui/".$row[$GLOBALS['OOO0000O0']('aW1nZmlsZQ==')]);
}
if($row[$GLOBALS['OOO0000O0']('dmlkZW9maWxl')]!=""){
...
require($GLOBALS['OOO0000O0']('dGVtcGxhdGUvdnJwYW5vX3VpX2RlbC5odG0='));
?>
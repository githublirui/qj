...
$xml .= '<hotspot name="introimage" alpha="0.6" url="introimage.png" onover="tween(alpha,1.0);" ondown="draghotspot();" onout="tween(alpha,0.6);" onclick="getback();"  keep="true" align="center"/>' . "\r\n";
$xml .= '</scene>' . "\r\n";

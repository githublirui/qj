        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $("#scaleup").click(function() {
                    ...
                    var n = krpano.get("hotspot[me].scale");
                    n = n + 0.05;
                    krpano.set("hotspot[me].scale", n);
                });
                ...
                $("#xup").click(function() {
                    var krpano = document.getElementById("krpanoSWFObject");
                    var n = krpano.get("hotspot[me].rx");
                    n = n + 1;
                    krpano.set("hotspot[me].rx", n);
                });
                ...
                $("#yup").click(function() {
                    var krpano = document.getElementById("krpanoSWFObject");
                    var n = krpano.get("hotspot[me].ry");
                    n = n + 1;
                    krpano.set("hotspot[me].ry", n);
                });
                ...
                $("#zup").click(function() {
                    var krpano = document.getElementById("krpanoSWFObject");
                    var n = krpano.get("hotspot[me].rz");
                    n = n + 1;
                    krpano.set("hotspot[me].rz", n);
                });

...
EOT;
    ...
    function DisplayError($msg) {
        ...
        $emsg = '';
        $emsg .= "<div><h3>LulinCMS Error Warning!</h3>\r\n";
        $emsg .= "<div><a href='http://bbs.lulincms.com' target='_blank' style='color:red'>Technical Support: http://bbs.lulincms.com</a></div>";
...
if (!function_exists('CheckSql')) {
    ...
    function CheckSql($db_string, $querytype='select') {
        ...
        $old_pos = 0;
        $pos = -1;
        $log_file = LULINREQ . '/../data/' . md5($cfg_cookie_encode) . '_safe.txt';
        $userIP = GetIP();
        $getUrl = GetCurUrl();
